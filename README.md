...
## roadmap
more contracts > more items (buy & earn) > more stats/effects to tools etc > defense system(firewall, kinda tower defense?) > story/intro 0.1 > home (customization, mby better pc etc) > onwards 

## notes
```
focusing on sp foundations now
mp stays "split" from sp
```
